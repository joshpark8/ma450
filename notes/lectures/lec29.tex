...
\begin{corollary}
  The converse of Lagrange's theorem holds for finite abelian groups and \tun{all finite gps of prime} \tun{power order} (if \(\order{G} = p^k\), then for any \(m\leq k\ \exists H \sgp G\) st \(\order{H}=p^m\)).
\end{corollary}
