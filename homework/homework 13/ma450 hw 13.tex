...
\tbo{Exercise 13.30.}
Let \( d \) be a positive integer. Prove that \( \![\sqrt d] = \{a + b\sqrt d\st a,b\in\!\}\) is a field.
...
\tbo{Exercise 14.10.}
If \( A \) and \( B \) are ideals of a ring, show that the \tit{sum} of \( A \) and \( B \), \( A+B = \{a+b\st a\in A,b\in B\} \), is an ideal.
...
\tbo{Exercise 14.12.}
If \( A \) and \( B \) are ideals of a ring, show that the \tit{product} of \( A \) and \( B \), \( AB = \{a_1b_1 + a_2b_2 + \cdots + a_nb_n \st a_i\in A, b_i\in B, n \in\ZZ{>0}\} \), is an ideal.
